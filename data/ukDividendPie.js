...
const ukDividendPie = [
  {
    t: 'RR.L', label: 'RR', n: 'Rolls-Royce', w: 11, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'IUSA.L', label: 'IUSA', n: 'iShares Core S&P 500 (Dist)', w: 9, exch: 'LSE', isIndexFund: true,
  ...
  {
    t: 'LLOY.L', label: 'LLOY', n: 'Lloyds Banking Group', w: 9, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'CNKY.L', label: 'CNKY', n: 'iShares Nikkei 225 (Acc)', w: 7, exch: 'LSE', isIndexFund: true,
    yieldPct: 0, frequency: 'Accumulating — no cash dividend',
    payments: [], analyst: null, eps: null,
  },
  {
    t: 'LGEN.L', label: 'LGEN', n: 'Legal & General', w: 7, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'VWRL.L', label: 'VWRL', n: 'Vanguard FTSE All-World (Dist)', w: 6, exch: 'LSE', isIndexFund: true,
    yieldPct: 1.8, frequency: 'Quarterly',
    payments: [{ label: 'Typical', months: 'Mar, Jun, Sep, Dec', splitPct: 25, estimated: true }],
    analyst: null, eps: null,
  },
  {
    t: 'VHYL.L', label: 'VHYL', n: 'Vanguard FTSE All-World High Div Yield (Dist)', w: 6, exch: 'LSE', isIndexFund: true,
    yieldPct: 2.5, frequency: 'Quarterly',
    payments: [{ label: 'Typical', months: 'Mar, Jun, Sep, Dec', splitPct: 25, estimated: true }],
    analyst: null, eps: null,
  },
  {
    t: 'ISF.L', label: 'ISF', n: 'iShares Core FTSE 100 (Dist)', w: 5, exch: 'LSE', isIndexFund: true,
  ...
  {
    t: 'BATS.L', label: 'BATS', n: 'British American Tobacco', w: 4, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'AZN.L', label: 'AZN', n: 'AstraZeneca', w: 3, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'CCH.L', label: 'CCH', n: 'Coca-Cola HBC', w: 3, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'HSBA.L', label: 'HSBA', n: 'HSBC', w: 3, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'INTC', label: 'INTC', n: 'Intel', w: 3, exch: 'US', isIndexFund: false,
  ...
  {
    t: 'NG.L', label: 'NG', n: 'National Grid', w: 3, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'RIO.L', label: 'RIO', n: 'Rio Tinto', w: 3, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'BP.L', label: 'BP', n: 'BP', w: 2, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'ULVR.L', label: 'ULVR', n: 'Unilever', w: 2, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'GSK.L', label: 'GSK', n: 'GSK', w: 2, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'MNG.L', label: 'MNG', n: 'M&G', w: 2, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'SSE.L', label: 'SSE', n: 'SSE', w: 2, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'ABDN.L', label: 'SDLF', n: 'Standard Life (abrdn)', w: 2, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'BARC.L', label: 'BARC', n: 'Barclays', w: 2, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'GAW.L', label: 'GAW', n: 'Games Workshop', w: 1, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'KLAC', label: 'KLAC', n: 'KLA Corp', w: 1, exch: 'US', isIndexFund: false,
  ...
  {
    t: 'NXT.L', label: 'NXT', n: 'Next', w: 1, exch: 'LSE', isIndexFund: false,
  ...
  {
    t: 'PHP.L', label: 'PHP', n: 'Primary Health Properties', w: 1, exch: 'LSE', isIndexFund: false,
